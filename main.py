...
class AllTest:  # 定义一个类AllTest
    def __init__(self):  # 初始化一些参数和数据
        ...
        resultPath = os.path.join(os.getcwd(), r'result/' + timestamp + r'report.html')  # result/report.html
        self.caseListFile = os.path.join(os.getcwd(), r'caselist.txt')  # 配置执行哪些测试文件的配置文件路径
        self.caseFile = os.path.join(path, "casedata")  # 真正的测试断言文件路径
        self.caseList = []
